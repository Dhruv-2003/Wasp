          ...
          <div className="flex md:flex-row flex-col">
            <div className="md:w-3/5 w-full">
              <div className="w-full flex-col md:h-screen">
                ...
                <div className="flex md:h-1/2 md:flex-row flex-col mt-3 w-full">
                  <div onClick={() => router.push("/dca")} className="px-7 py-2 md:mr-2 bg-white md:mt-0 mt-3 md:w-1/2 w-full rounded-2xl border-4 hover:border-yellow-500 cursor-pointer">
                    <p className="text-black text-4xl">Dollar Cost Average <span className="text-yellow-500">Strategy</span></p>
                  ...
                  <div  onClick={() => router.push("/rangeorder")}  className="px-10 py-2 md:ml-2 bg-white border-4 border-white hover:border-yellow-500 cursor-pointer md:mt-0 mt-3 md:w-1/2 w-full rounded-2xl">
            ...
            <div className="md:w-2/5 w-full">
              <div className="w-full md:h-screen">
                <div  onClick={() => router.push("/clmmanager")} className="px-10 py-2 md:mr-2 border-4 border-white hover:border-yellow-500 cursor-pointer md:mx-5 mx-0 mt-5 md:mt-0 rounded-2xl md:h-full">
